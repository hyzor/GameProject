...
void GenericMesh::setIndices(ID3D11Device* device, const UINT* indices, UINT count)
{
...
void GenericMesh::draw(ID3D11DeviceContext* deviceContext)
{
	UINT offset = 0;
